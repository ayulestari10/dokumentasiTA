				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<?= form_open_multipart('admin/profile') ?>
							<div>
								<input type="hidden" name="nipus" value="<?= $data->NIPUS ?>">
								<div class="form-group">
									<label for="NIPUS">NIPUS</label>
									<input type="text" value="<?= $data->NIPUS ?>" class="form-control" disabled>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<img src="<?= base_url('assets/foto/admin/'.$username.'.jpg') ?>" alt="User" onerror='src="<?= base_url('assets/production/') ?>images/img.jpg"' style="width: 200px; height: 250px;">
